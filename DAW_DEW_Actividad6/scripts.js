    ...
    if (statusText === "success") {
        ...
        switch (content) {
            case "page_1":
                ...
                mainDiv.load("content_1.html", function (responseText, statusText, xhr) {
                    if (statusText === "success") {
            ...
            case "page_2":
                ...
                mainDiv.load("content_2.html", function (responseText, statusText, xhr) {
                    if (statusText === "success") {
            ...
            case "page_3":
                ...
                mainDiv.load("content_3.html", function (responseText, statusText, xhr) {
                    if (statusText === "success") {
